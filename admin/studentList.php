    ...
    <table class="layui-table layui-table-hover">
        ...
        while ($row = $res->fetch_array()) {
            ...
            <tr bgColor="#ffffff">
                ...
                <td>
                    <button class="layui-btn " onclick="updateinfo(<?php echo $row['xuehao']; ?>)">修改
                    <i class="layui-icon layui-icon-fonts-clear" style="font-size: 10px; color: rgba(91, 130, 183, 0.9);"></i></button>
